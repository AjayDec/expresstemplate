(function () {
    ...
    var service = function ($q, Offline,
        remotePersistenceStrategy, localPersistenceStrategy) {
        var self = this;
            ...
            if (Offline.state === 'up') {
                ...
                self.getRemoteHome(id).then(function (rHome) {
                    ...
                    self.getLocalHome(id).then(function (lHome) {
                        localHome = lHome;
                        if (localHome.modifiedHome > (new Date(remoteHome.modifiedDate))) {
    ...
    app.service('persistenceService', ['$q', 'Offline',
                                       'remotePersistenceStrategy',
